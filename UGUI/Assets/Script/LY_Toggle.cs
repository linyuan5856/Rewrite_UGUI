...
public class LY_Toggle : UIBehaviour, IPointerClickHandler, ISubmitHandler
{
    ...
    [SerializeField]
    private LY_ToggleGroup m_Group;

    public LY_ToggleGroup group
    {
        get { return m_Group; }
        set
        {
    ...
    private void SetToggleGroup(LY_ToggleGroup newGroup, bool setMemberValue)
    {
        LY_ToggleGroup old = this.m_Group;
